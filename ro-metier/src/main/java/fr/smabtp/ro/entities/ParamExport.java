...
public class ParamExport implements Serializable {
    ...
    public Date getPexDtlastexport() {
        return pexDtlastexport;
    }

    public ParamExport pexDtlastexport(Date pexDtlastexport) {
        this.pexDtlastexport = pexDtlastexport;
        return this;
    }

    public void setPexDtlastexport(Date pexDtlastexport) {
        this.pexDtlastexport = pexDtlastexport;
    }
